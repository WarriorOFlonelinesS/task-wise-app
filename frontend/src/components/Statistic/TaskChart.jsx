import {BarChart,CartesianGrid, Bar, XAxis, YAxis, ResponsiveContainer, Tooltip, Cell } from 'recharts';
        ...
        <div className='flex justify-center my-7'>
            <div className="w-3/4 h-80 backdrop-blur-md bg-white/5 border border-white/10 p-8 rounded-lg">
                ...
                <ResponsiveContainer width="100%" height="100%">
                    ...
                    <Tooltip cursor={false} contentStyle={{ backgroundColor: '#184e4a', border: 'none', borderRadius: '8px', color: 'white' }} itemStyle={{ color: 'white' }}
