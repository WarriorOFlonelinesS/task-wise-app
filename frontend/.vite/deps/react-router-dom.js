        ...
        while (Object.keys(encoder2.deferred).length > 0) {
          for (const [deferredId, deferred] of Object.entries(encoder2.deferred)) {
            ...
            seenPromises.add(
              ...
              (encoder2.deferred[Number(deferredId)] = Promise.race([racePromise, deferred])
                .then(
                  (resolved) => {
...
function Links() {
  ...
  return React9.createElement(
    ...
    typeof criticalCss === 'string'
      ? React9.createElement('style', { dangerouslySetInnerHTML: { __html: criticalCss } })
      : null,
    typeof criticalCss === 'object'
      ? React9.createElement('link', { rel: 'stylesheet', href: criticalCss.href })
      : null,
...
function PrefetchPageLinksImpl({ page, matches: nextMatches, ...linkProps }) {
  ...
  return React9.createElement(
    ...
    moduleHrefs.map((href2) =>
      React9.createElement('link', { key: href2, rel: 'modulepreload', href: href2, ...linkProps }),
    ),
