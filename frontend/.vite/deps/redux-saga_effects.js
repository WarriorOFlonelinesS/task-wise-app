...
function takeEvery(patternOrChannel, worker) {
  ...
  var action,
    setAction = function setAction2(ac) {
      return (action = ac);
    };
  return fsmIterator(
    {
...
function throttle$1(ms, patternOrChannel, worker) {
  ...
  for (
    var _len4 = arguments.length, args = new Array(_len4 > 3 ? _len4 - 3 : 0), _key4 = 3;
    _key4 < _len4;
    _key4++
  ) {
...
function debounce(delayLength, pattern, worker) {
  for (
    var _len6 = arguments.length, args = new Array(_len6 > 3 ? _len6 - 3 : 0), _key6 = 3;
    _key6 < _len6;
    _key6++
  ) {
